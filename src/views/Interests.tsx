  ...
  return (
    <div className="max-w-[560px] mx-auto">
      <div className="bg-panel border border-line rounded-[16px] px-6 py-8">
        <div className="flex items-center gap-1.5 text-amber text-[11px] uppercase tracking-[2px] font-semibold mb-2">
          <Compass size={14} /> Personalize
        </div>
        <h1 className="text-[20px] sm:text-[22px] font-bold mb-1.5">What do you want to talk about?</h1>
        <p className="text-dim text-[15px] mb-5 max-w-[48ch]">

...
import { Network, Play, Check, SlidersHorizontal, ChevronDown } from 'lucide-react';
import { sectorStats, completions, levels } from '../store.ts';
        ...
        {decks.map((d) => (
          <Card key={d.name} tone="sunken" nested pad="none"
            ...
            <div className="flex items-start justify-between gap-2">
              ...
              {/* These had no sizing class at all — a 15px icon with no
